...
# {
#   "code": "REQUEST_CHAT_CONTEXT",
#   "data": null
# }
#
# От клиента к серверу (контекст):
# {
#   "code": "CHAT_CONTEXT",
#   "data": [
#     {"role": "user", "content": "..."},
...
# }
#
# От клиента к серверу (сообщение):
# {
#   "code": "SEND_MESSAGE",
#   "data": {"message": "Текст сообщения"}
# }
#
# От сервера к клиенту (статус):
# {
#   "code": "STATUS_RAG_PROCESSING",
#   "data": {"message": "Поиск в базе знаний..."}
# }
#
# От сервера к клиенту (ответ):
# {
